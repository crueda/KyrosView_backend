...
PID = "/var/run/json-generator-kyrosview-speed-lastday"
...
def openJsonFiles():
	...
	for k in devices.keys():
		speedJsonFile[k] = open(JSON_DIR + '/devices/speed/lastDay/' + str(k) + '.json', "a+")
...
os.system("rm -f " + JSON_DIR + "/devices/speed/lastDay/*.json")
openJsonFiles()
