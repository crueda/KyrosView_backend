...
PID = "/var/run/json-generator-kyrosview-altitude-lastweek"
...
def openJsonFiles():
	...
	for k in devices.keys():
		altitudeJsonFile[k] = open(JSON_DIR + '/devices/altitude/lastWeek/' + str(k) + '.json', "a+")
...
os.system("rm -f " + JSON_DIR + "/devices/altitude/lastWeek/*.json")
openJsonFiles()
